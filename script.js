...
const flags = document.querySelectorAll("#language-toggle, #language-toggle-mobile");
let currentLang = "en"; // langue actuelle du site
...
flags.forEach((flag) => {
	flag.addEventListener("click", () => {
		...
		flags.forEach((f) => {
			if (currentLang === "en") {
				f.src = "https://flagcdn.com/w20/fr.png";
				f.alt = "Changer de langue";
				f.title = "Changer de langue";
			} else {
				f.src = "https://flagcdn.com/w20/gb.png";
				f.alt = "Switch language";
				f.title = "Switch language";
			}
		});
	});
});
